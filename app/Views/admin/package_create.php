...
<div class="flex justify-between items-center pb-4">
    <h2 class="text-2xl font-bold">Create New Wedding Package</h2>
</div>
...
<form id="packageForm" method="POST" action="<?= site_url('admin/package/store') ?>" enctype="multipart/form-data">
    <div class="mb-4">
        <label for="package_name" class="block text-gray-700 text-sm font-bold mb-2">Package Name:</label>
        <input type="text" id="package_name" name="package_name" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" required>
    </div>
